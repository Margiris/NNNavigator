...
class Brain:
    ...
    def draw(self):
        ...
        for direction, coord in self.player.DIRECTIONS.items():
            ...
            end_pos = (start_pos[0] + coord[0] * self.player.vision_distance[direction][0] * self.player.tile_size[0] * Settings.VISION_DISTANCE / diagonal_div,
                       start_pos[1] + coord[1] * self.player.vision_distance[direction][0] * self.player.tile_size[1] * Settings.VISION_DISTANCE / diagonal_div)
